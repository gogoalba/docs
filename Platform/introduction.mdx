...
<Tabs>
  <Tab title="OpenAI SDK → Claude">
    ...
    client = OpenAI(
        ...
        base_url="https://api.portix.ai/openai/v1"  # ← just change this
    )
  ...
  <Tab title="Anthropic SDK → Gemini">
    ...
    client = anthropic.Anthropic(
        api_key="YOUR_API_KEY",
        base_url="https://api.portix.ai/anthropic"  # ← just change this
    )
  ...
  <Tab title="Gemini SDK → GPT">
    ...
    client = genai.Client(
        api_key="YOUR_API_KEY",
        http_options={"base_url": "https://api.portix.ai/gemini"}  # ← just change this
    )
