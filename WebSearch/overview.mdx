...
WebSearch is a standalone product surface for real-time search, retrieval, and page reading. It can be used directly through Portix's public API or installed as the `portix-websearch` npm package for OpenClaw.
