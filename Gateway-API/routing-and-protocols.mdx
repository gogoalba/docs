...
- Native public routes on `https://portix.ai`
...
| Goal | Route to use |
| --- | --- |
| Keep OpenAI SDK, call Claude | `https://portix.ai/openai/v1/chat/completions` |
| Keep OpenAI SDK, call Gemini | `https://portix.ai/openai/v1/chat/completions` |
| Keep Anthropic SDK, call GPT | `https://portix.ai/anthropic/v1/messages` |
| Keep Anthropic SDK, call Gemini | `https://portix.ai/anthropic/v1/messages` |
| Keep Gemini SDK, call GPT | `https://portix.ai/gemini/v1beta/models/{model}:generateContent` |
| Keep Gemini SDK, call Claude | `https://portix.ai/gemini/v1beta/models/{model}:generateContent` |
