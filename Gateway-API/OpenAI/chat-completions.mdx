...
```text
POST https://portix.ai/v1/chat/completions
```
...
<Tabs>
  <Tab title="cURL">
    ```bash
    curl https://portix.ai/v1/chat/completions \
  ...
  <Tab title="Go">
    ...
    func main() {
      ...
      config.BaseURL = "https://portix.ai/v1"
